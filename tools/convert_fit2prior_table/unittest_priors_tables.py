...
class TestWriteTable(unittest.TestCase):
    ...
    def test_make_prior_table_1D(self):
        binning = 30
        work_dir = os.getcwd()
        ...
        generated_image_path = output_dir + "10280410_Gaussfit1d.priors.jpg"
        self.assertImagesEqual(expected_image_path, generated_image_path)

        # Add assertion here for the correctness of the plot

    def test_make_prior_table_2D(self):
        binning = 30
        work_dir = os.getcwd()
        process_name = "10280410_Gaussfit"
        dir_tamcmc_outputs = work_dir + "/test_data/" #+ process_name + "/outputs/"
        ...
        generated_image_path = output_dir + "10280410_Gaussfit2d.priors.jpg"
        self.assertImagesEqual(expected_image_path, generated_image_path)
