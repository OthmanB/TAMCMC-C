...
pro showbestfit
  ...
  dir_outputs = '/Users/obenomar/Work/dev/TAMCMC-C-v1.86.4/test/outputs/Kallinger2014_Gaussian/LC_CORR_FILT_INP_ASCII/'
  dir_inputs = '/Users/obenomar/Work/dev/TAMCMC-C-v1.86.4/test/inputs/Kallinger2014_Gaussian/LC_CORR_FILT_INP_ASCII/rebinned/'
  dir_out = dir_OS + '/'
  modelname = 'model_Kallinger2014_Gaussian'
  phase_list = 'L*'
  index0_list = 40000 ;
  last_index = -1 ;
