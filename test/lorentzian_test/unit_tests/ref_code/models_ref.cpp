...
VectorXd model_MS_Global_a1l_etaa3_HarveyLike_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    ...
    for(long n=0; n<Nmax; n++){
        ...
        model_final=optimum_lorentzian_calc_a1l_etaa3_ref(x, model_final, Hl0, fl0, a11, a12, eta0, a3, asym, Wl0, 0, ratios_l0, step, trunc_c);
        ...
        if(lmax >=1){
           ...
           model_final=optimum_lorentzian_calc_a1l_etaa3_ref(x, model_final, Hl1, fl1, a11, a12, eta0, a3,asym, Wl1, 1, ratios_l1, step, trunc_c);
        }
        if(lmax >=2){
            ...
            model_final=optimum_lorentzian_calc_a1l_etaa3_ref(x, model_final, Hl2, fl2, a11, a12, eta0, a3,asym, Wl2, 2, ratios_l2, step, trunc_c);
        }
        if(lmax >=3){
            ...
            model_final=optimum_lorentzian_calc_a1l_etaa3_ref(x, model_final, Hl3, fl3, a11, a12, eta0, a3, asym, Wl3, 3, ratios_l3, step, trunc_c);
        }
    }
    //std::cin.ignore();
...
VectorXd model_MS_Global_a1n_etaa3_HarveyLike_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
    ...
    for(long n=0; n<Nmax; n++){
		...
		a1_l1=std::abs(a11[n]);
		a1_l2=std::abs(a12[n]);
        model_final=optimum_lorentzian_calc_a1l_etaa3_ref(x, model_final, Hl0, fl0, a1_l1, a1_l2, eta0, a3, asym, Wl0, 0, ratios_l0, step, trunc_c);
        if (outparams){
            mode_params.row(Line) << 0, fl0, Hl0 , Wl0, 0, 0, 0, 0, asym, inclination;// mode_vec;
            Line=Line+1;
        }   
        ...
        if(lmax >=1){
            ...
            model_final=optimum_lorentzian_calc_a1l_etaa3_ref(x, model_final, Hl1, fl1, a1_l1, a1_l2, eta0, a3,asym, Wl1, 1, ratios_l1, step, trunc_c);
           if (outparams){
        ...
        if(lmax >=2){
            ...
            model_final=optimum_lorentzian_calc_a1l_etaa3_ref(x, model_final, Hl2, fl2, a1_l1, a1_l2, eta0, a3,asym, Wl2, 2, ratios_l2, step, trunc_c);
            if (outparams){
        ...
        if(lmax >=3){
            ...
            model_final=optimum_lorentzian_calc_a1l_etaa3_ref(x, model_final, Hl3, fl3, a1_l1, a1_l2, eta0, a3, asym, Wl3, 3, ratios_l3, step, trunc_c);
            if (outparams){
...
VectorXd model_MS_Global_a1n_a2a3_HarveyLike_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
    ...
    for(long n=0; n<Nmax; n++){
        ...
        a1_l2=std::abs(a12[n]);
        a2=0;
        model_final=optimum_lorentzian_calc_a1l_a2a3_ref(x, model_final, Hl0, fl0, a1_l1, a1_l2, 0, 0, asym, Wl0, 0, ratios_l0, step, trunc_c);
        if (outparams){
            mode_params.row(Line) << 0, fl0, Hl0 , Wl0, 0, 0, 0, 0, asym, inclination;// mode_vec;
            Line=Line+1;
        }   
        if(lmax >=1){
            ...
            model_final=optimum_lorentzian_calc_a1l_a2a3_ref(x, model_final, Hl1, fl1, a1_l1, a1_l2, a2_terms[n], a3,asym, Wl1, 1, ratios_l1, step, trunc_c);
           if (outparams){
        ...
        if(lmax >=2){
            ...
            model_final=optimum_lorentzian_calc_a1l_a2a3_ref(x, model_final, Hl2, fl2, a1_l1, a1_l2, a2_terms[n], a3,asym, Wl2, 2, ratios_l2, step, trunc_c);
            if (outparams){
        ...
        if(lmax >=3){
            ...
            model_final=optimum_lorentzian_calc_a1l_a2a3_ref(x, model_final, Hl3, fl3, a1_l1, a1_l2, a2_terms[n], a3, asym, Wl3, 3, ratios_l3, step, trunc_c);
            if (outparams){
...
VectorXd model_MS_Global_a1l_a2a3_HarveyLike_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
    ...
    for(long n=0; n<Nmax; n++){
        ...
        model_final=optimum_lorentzian_calc_a1l_a2a3_ref(x, model_final, Hl0, fl0, 0, 0, 0, 0, asym, Wl0, 0, ratios_l0, step, trunc_c);
        if (outparams){
        ...
        if(lmax >=1){
            ...
            model_final=optimum_lorentzian_calc_a1l_a2a3_ref(x, model_final, Hl1, fl1, a11, a12, a2, a3,asym, Wl1, 1, ratios_l1, step, trunc_c);
           if (outparams){
        ...
        if(lmax >=2){
            ...
            model_final=optimum_lorentzian_calc_a1l_a2a3_ref(x, model_final, Hl2, fl2, a11, a12, a2, a3,asym, Wl2, 2, ratios_l2, step, trunc_c);
            if (outparams){
        ...
        if(lmax >=3){
           ...
           model_final=optimum_lorentzian_calc_a1l_a2a3_ref(x, model_final, Hl3, fl3, a11, a12, a2, a3, asym, Wl3, 3, ratios_l3, step, trunc_c);
            if (outparams){
...
VectorXd model_MS_Global_a1nl_a2a3_HarveyLike_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
...
VectorXd model_MS_Global_a1nl_etaa3_HarveyLike_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
...
VectorXd model_MS_Global_aj_HarveyLike_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
    ...
    */
    ...
    for(long n=0; n<Nfl0; n++){        
        ...
        model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl0, fl0, 0, 0, 0, 0, 0, 0, 0, asym, Wl0, 0, ratios_l0, step, trunc_c);
       if (outparams){
    ...
    for(long n=0; n<Nfl1; n++){        
        ...
        model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl1, fl1, a1, a2, a3,a4, a5,a6,eta0,asym, Wl1, 1, ratios_l1, step, trunc_c);
        if (outparams){
    ...
    for(long n=0; n<Nfl2; n++){        
        ...
        model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl2, fl2, a1, a2, a3,a4,a5,a6, eta0,asym, Wl2, 2, ratios_l2, step, trunc_c);
        if (outparams){
    ...
    for(long n=0; n<Nfl3; n++){        
        ...
        model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl3, fl3, a1, a2, a3, a4, a5,a6, eta0, asym, Wl3, 3, ratios_l3, step, trunc_c);
        if (outparams){
...
VectorXd model_MS_Global_ajAlm_HarveyLike_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams, external_data extra_data) // Added on 31 Mar 2021
    {
    /* Model of the power spectrum of a Main sequence solar-like star
    ...
    */
    ...
    for(long n=0; n<Nfl1; n++){        
        ...
        switch (decompose_Alm){
            case -1:
                model_final=optimum_lorentzian_calc_ajAlm_ref(x, model_final, Hl1, fl1, a1, a3, a5, eta0, epsilon_nl, thetas, asym, Wl1, 1, ratios_l1, step, trunc_c, filter_type, Alm_interp);
                break;
            // do_a2, do_a4, do_a6
            case 0: // decompose_Alm = 0 ==> do_a2=true, do_a4=true, do_a6=true
                ...
                model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl1, fl1, a1, aj[1], a3, aj[3], a5,aj[5], eta0, asym, Wl1, 1, ratios_l1, step, trunc_c);   
                break; 
            case 1:  // decompose_Alm = 1 ==> do_a2=true, do_a4=true, do_a6=false
                aj=decompose_Alm_fct_GSLgrid(1, fl1, eta0, a1, epsilon_nl, thetas, filter_type, Alm_interp); // Use a grid to generate and decompose
                //aj=decompose_Alm_fct(1, fl1, eta0, a1, epsilon_nl, thetas, filter_type); // Generate fl1(m) and decompose it to get aj coefficients. decompose_Alm contains the rule to apply: do we use a2? a4? a6? )
                aj[5]=0;
                model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl1, fl1, a1, aj[1], a3, aj[3], a5, 0, eta0, asym, Wl1, 1, ratios_l1, step, trunc_c);   
                break; 
            case 2:  // decompose_Alm = 1 ==> do_a2=true, do_a4=false, do_a6=false
                aj=decompose_Alm_fct_GSLgrid(1, fl1, eta0, a1, epsilon_nl, thetas, filter_type, Alm_interp); // Use a grid to generate and decompose
                //aj=decompose_Alm_fct(1, fl1, eta0, a1, epsilon_nl, thetas, filter_type); // Generate fl1(m) and decompose it to get aj coefficients. decompose_Alm contains the rule to apply: do we use a2? a4? a6? )
                aj[3]=0; aj[5]=0;
                model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl1, fl1, a1, aj[1], a3, 0, a5, 0, eta0, asym, Wl1, 1, ratios_l1, step, trunc_c);   
                break; 
            default:
    ...
    for(long n=0; n<Nfl2; n++){        
        ...
        switch (decompose_Alm){
            case -1:
                model_final=optimum_lorentzian_calc_ajAlm_ref(x, model_final, Hl2, fl2, a1, a3, a5, eta0, epsilon_nl, thetas, asym, Wl2, 2, ratios_l2, step, trunc_c, filter_type, Alm_interp);
                break;
            // do_a2, do_a4, do_a6
            case 0: // decompose_Alm = 0 ==> do_a2=true, do_a4=true, do_a6=true
                ...
                model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl2, fl2, a1, aj[1], a3, aj[3], a5,aj[5], eta0, asym, Wl2, 2, ratios_l2, step, trunc_c);   
                break; 
            case 1:  // decompose_Alm = 1 ==> do_a2=true, do_a4=true, do_a6=false
                aj=decompose_Alm_fct_GSLgrid(2, fl2, eta0, a1, epsilon_nl, thetas, filter_type, Alm_interp); // Use a grid to generate and decompose
                //aj=decompose_Alm_fct(2, fl2, eta0, a1, epsilon_nl, thetas, filter_type); // Generate fl1(m) and decompose it to get aj coefficients. decompose_Alm contains the rule to apply: do we use a2? a4? a6? )
                aj[5]=0;
                model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl2, fl2, a1, aj[1], a3, aj[3], a5, 0, eta0, asym, Wl2, 2, ratios_l2, step, trunc_c);   
                break; 
            case 2:  // decompose_Alm = 1 ==> do_a2=true, do_a4=false, do_a6=false
                aj=decompose_Alm_fct_GSLgrid(2, fl2, eta0, a1, epsilon_nl, thetas, filter_type, Alm_interp); // Use a grid to generate and decompose
                //aj=decompose_Alm_fct(2, fl2, eta0, a1, epsilon_nl, thetas, filter_type); // Generate fl1(m) and decompose it to get aj coefficients. decompose_Alm contains the rule to apply: do we use a2? a4? a6? )
                aj[3]=0; aj[5]=0;
                model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl2, fl2, a1, aj[1], a3, 0, a5, 0, eta0, asym, Wl2, 2, ratios_l2, step, trunc_c);   
                break; 
            default:
                std::cout << " Error in model_MS_Global_ajAlm_HarveyLike: decompose_Alm must be set to -1 (use Alm directly), 0 (do_a2=true, do_a4=true, do_a6=true), 1 (do_a2=true, do_a4=true, do_a6=fasle) or 2 (do_a2=true, do_a4=false, do_a6=false) " << std::endl;
                exit(EXIT_FAILURE);
    ...
    for(long n=0; n<Nfl3; n++){        
        ...
        switch (decompose_Alm){
            case -1:
                model_final=optimum_lorentzian_calc_ajAlm_ref(x, model_final, Hl3, fl3, a1, a3, a5, eta0, epsilon_nl, thetas, asym, Wl3, 3, ratios_l3, step, trunc_c, filter_type, Alm_interp);
                break;
            // do_a2, do_a4, do_a6
            case 0: // decompose_Alm = 0 ==> do_a2=true, do_a4=true, do_a6=true
                ...
                model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl3, fl3, a1, aj[1], a3, aj[3], a5,aj[5], eta0, asym, Wl3, 3, ratios_l3, step, trunc_c);   
                break; 
            case 1:  // decompose_Alm = 1 ==> do_a2=true, do_a4=true, do_a6=false
                aj=decompose_Alm_fct_GSLgrid(3, fl3, eta0, a1, epsilon_nl, thetas, filter_type, Alm_interp); // Use a grid to generate and decompose                
                //aj=decompose_Alm_fct(3, fl3, eta0, a1, epsilon_nl, thetas, filter_type); // Generate fl1(m) and decompose it to get aj coefficients. decompose_Alm contains the rule to apply: do we use a2? a4? a6? )
                aj[5]=0;
                model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl3, fl3, a1, aj[1], a3, aj[3], a5, 0, eta0, asym, Wl3, 3, ratios_l3, step, trunc_c);   
                break; 
            case 2:  // decompose_Alm = 1 ==> do_a2=true, do_a4=false, do_a6=false
                aj=decompose_Alm_fct_GSLgrid(3, fl3, eta0, a1, epsilon_nl, thetas, filter_type, Alm_interp); // Use a grid to generate and decompose                
                //aj=decompose_Alm_fct(3, fl3, eta0, a1, epsilon_nl, thetas, filter_type); // Generate fl1(m) and decompose it to get aj coefficients. decompose_Alm contains the rule to apply: do we use a2? a4? a6? )
                aj[3]=0; aj[5]=0;
                model_final=optimum_lorentzian_calc_aj_ref(x, model_final, Hl3, fl3, a1, aj[1], a3, 0, a5, 0, eta0, asym, Wl3, 3, ratios_l3, step, trunc_c);   
                break; 
            default:
                std::cout << " Error in model_MS_Global_ajAlm_HarveyLike: decompose_Alm must be set to -1 (use Alm directly), 0 (do_a2=true, do_a4=true, do_a6=true), 1 (do_a2=true, do_a4=true, do_a6=fasle) or 2 (do_a2=true, do_a4=false, do_a6=false) " << std::endl;
                exit(EXIT_FAILURE);
...
VectorXd model_MS_Global_a1etaa3_Harvey1985_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
	/* Model of the power spectrum of a Main sequence solar-like star
	 * param is a vector of parameters
	 * param_length defines the structure of the parameters
	 * x is the frequency assumed to be in microHz
	...
	*/
	...
	for(long n=0; n<Nmax; n++){
		...
		model_final=optimum_lorentzian_calc_a1etaa3_ref(x, model_final, Hl0, fl0, a1, eta0, a3, asym, Wl0, 0, ratios_l0, step, trunc_c);
        if (outparams){
            mode_params.row(Line) << 0, fl0, Hl0 , Wl0, 0, 0, 0, asym, inclination;// mode_vec;
            Line=Line+1;
        }   
		if(lmax >=1){
			...
			model_final=optimum_lorentzian_calc_a1etaa3_ref(x, model_final, Hl1, fl1, a1, eta0, a3,asym, Wl1, 1, ratios_l1, step, trunc_c);
           if (outparams){
		...
		if(lmax >=2){
			...
			model_final=optimum_lorentzian_calc_a1etaa3_ref(x, model_final, Hl2, fl2, a1, eta0, a3,asym, Wl2, 2, ratios_l2, step, trunc_c);
            if (outparams){
        ...
        if(lmax >=3){
			...
			model_final=optimum_lorentzian_calc_a1etaa3_ref(x, model_final, Hl3, fl3, a1, eta0, a3, asym, Wl3, 3, ratios_l3, step, trunc_c);
            if (outparams){
...
VectorXd model_MS_Global_a1etaa3_HarveyLike_Classic_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
	/* Model of the power spectrum of a Main sequence solar-like star
	 * param is a vector of parameters
	 * param_length defines the structure of the parameters
	 * x is the frequency assumed to be in microHz
...
VectorXd model_MS_Global_a1etaa3_HarveyLike_Classic_v2_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
...
VectorXd model_MS_Global_a1etaa3_HarveyLike_Classic_v3_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
    ...
    */
    ...
    for(long n=0; n<Nmax; n++){
        ...
        model_final=optimum_lorentzian_calc_a1etaa3_v2_ref(x, model_final, Hl0, fl0, a1, eta0, a3, asym, Wl0, 0, step, trunc_c);
        if (outparams){
            mode_params.row(Line) << 0, fl0, Hl0 , Wl0, 0, 0, 0, asym, inclination;// mode_vec;
            Line=Line+1;
        }       
        if(lmax >=1){
            ...
            Hl1=Hl1.cwiseAbs();
            model_final=optimum_lorentzian_calc_a1etaa3_v2_ref(x, model_final, Hl1, fl1, a1, eta0, a3,asym, Wl1, 1, step, trunc_c);
           if (outparams){
                mode_params.row(Line) << 1, fl1, Hl1 , Wl1, a1, eta0*1e-6, a3, asym, inclination;// mode_vec;
                Line=Line+1;
            }   
        ...
        if(lmax >=2){
            ...
            Hl2=Hl2.cwiseAbs();
            model_final=optimum_lorentzian_calc_a1etaa3_v2_ref(x, model_final, Hl2, fl2, a1, eta0, a3,asym, Wl2, 2, step, trunc_c);
            if (outparams){
                mode_params.row(Line) << 2, fl2, Hl2 , Wl2, a1, eta0*1e-6, a3, asym, inclination;// mode_vec;
                Line=Line+1;
            }    
        ...
        if(lmax >=3){
            ...
            Hl3=Hl3.cwiseAbs();
            model_final=optimum_lorentzian_calc_a1etaa3_v2_ref(x, model_final, Hl3, fl3, a1, eta0, a3, asym, Wl3, 3, step, trunc_c);
            if (outparams){
                mode_params.row(Line) << 3, fl3, Hl3 , Wl3, a1, eta0*1e-6, a3, asym, inclination;// mode_vec;
                Line=Line+1;
            } 
...
VectorXd model_MS_Global_a1etaa3_AppWidth_HarveyLike_v1_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
	/* Model of the power spectrum of a Main sequence solar-like star
	 * param is a vector of parameters
	 * param_length defines the structure of the parameters
	 * x is the frequency assumed to be in microHz
...
VectorXd model_MS_Global_a1etaa3_AppWidth_HarveyLike_v2_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
	/* Model of the power spectrum of a Main sequence solar-like star
	 * param is a vector of parameters
	 * param_length defines the structure of the parameters
	 * x is the frequency assumed to be in microHz
...
VectorXd model_MS_local_basic_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
...
VectorXd model_MS_local_Hnlm_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
...
VectorXd model_RGB_asympt_a1etaa3_AppWidth_HarveyLike_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
    ...
    */ 
    ...
    for(long n=0; n<Nfl0; n++){
        ...
        Hl0=Hl0_all[n];
        //std::cout << "Wl0=" << Wl0 << std::endl;
        model_final=optimum_lorentzian_calc_a1etaa3_ref(x, model_final, Hl0, fl0, 0, eta0, a3, asym, Wl0, 0, ratios_l0, step, trunc_c);
    ...
    for (long n=0; n<fl1_all.size(); n++){
        ...
        model_final=optimum_lorentzian_calc_a1etaa3_ref(x, model_final, Hl1, fl1, a1_l1[n], eta0, a3,asym, Wl1, 1, ratios_l1, step, trunc_c);
    ...
    for(long n=0; n<Nfl2; n++){ 
        ...
        model_final=optimum_lorentzian_calc_a1etaa3_ref(x, model_final, Hl2, fl2, a1_l2[n], eta0, a3,asym, Wl2, 2, ratios_l2, step, trunc_c);
    ...
    for(long n=0; n<Nfl3; n++){ 
        ...
        model_final=optimum_lorentzian_calc_a1etaa3_ref(x, model_final, Hl3, fl3, a1_l3[n], eta0, a3, asym, Wl3, 3, ratios_l3, step, trunc_c);
...
VectorXd model_RGB_asympt_a1etaa3_AppWidth_HarveyLike_v2_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
...
VectorXd model_RGB_asympt_a1etaa3_AppWidth_HarveyLike_v3_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
...
VectorXd model_RGB_asympt_a1etaa3_CteWidth_HarveyLike_v4_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
...
//    std::cout << "--------------- " << std::endl;
    ...
    */
    ...
    if(outparams){
        int c=0;
        std::string file_out="params_ref.model";
        std::string modelname = __func__;
        std::string name_params = "# Input mode parameters. degree / freq / H / W / a1 / eta0*1e-6 / a3 / asymetry / inclination";
        VectorXd spec_params(3);
        spec_params << x.minCoeff() , x.maxCoeff(), step;
...
VectorXd model_RGB_asympt_a1etaa3_AppWidth_HarveyLike_v4_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
   ...
   */
   ...
   if(do_amp){
    ...
    /*
    std::cout << "Hl0 : " << Hl0_all.transpose() << std::endl;
    std::cout << "Vl1,2 : " << Vl1 << " " << Vl2 << std::endl;
    std::cout << "Width l=0 : " << gamma_params << std::endl;
    std::cout << "delta0l : " << delta0l << std::endl;
    std::cout << "Dpl : " << DPl << std::endl;
    std::cout << "alpha_g : " << alpha_g << std::endl;
    std::cout << "q_star : " << q_star << std::endl;
    std::cout << " sigma_H_l1 : " << sigma_H_l1 << std::endl;
    std::cout << " sigma_g_l1 : " << sigma_g_l1 << std::endl;
    std::cout << " Wfactor : " << Wfactor << std::endl;
    std::cout << " Hfactor : " << Hfactor << std::endl;
    std::cout << " rotenv : " << rot_env << std::endl;
    std::cout << " rotcore : " << rot_core << std::endl;
    std::cout << "a3 :" << a3 << std::endl;
    ...
    */
    ...
    const double epsilon_p = rfit[1]/Dnu_p -n0;
    if(fmin - Dnu_p <0){
        std::cerr << " ERROR: THE ARMM WILL LIKELY NOT CONVERGE AS YOU HAVE fmin - Dnu_p < 0, leading the an INFINITE g modes density!" << std::endl;
...
VectorXd model_RGB_asympt_a1etaa3_CteWidth_HarveyLike_v3_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
...
VectorXd model_RGB_asympt_a1etaa3_freeWidth_HarveyLike_v3_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
    /* Model of the power spectrum of a Main sequence solar-like star
     * param is a vector of parameters
     * param_length defines the structure of the parameters
     * x is the frequency assumed to be in microHz
...
VectorXd model_Harvey_Gaussian_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
/*
...
VectorXd model_Harvey1985_Gaussian_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
/*
 * A model in which we fit a Gaussian + Harvey-Like profile.
 * Parameters are assumed to be in that order: Maximum Height, variance/width, central frequency, White noise
*/
...
VectorXd model_Test_Gaussian_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
/*
...
VectorXd model_ajfit_ref(const VectorXd& params, const VectorXi& params_length, const VectorXd& x, bool outparams){
...
///// ----------- FOR ASCII OUTPUTS  ------------ //////
void write_star_params_ref(const VectorXd& spec_params, const VectorXd& raw_params, const VectorXi& plength, const MatrixXd& mode_params, const MatrixXd& noise_params, 
...
void write_star_params_mixed_ref(const VectorXd& spec_params, const VectorXd& raw_params, const VectorXi& plength, const MatrixXd& mode_params, const MatrixXd& noise_params, 
...
bool debug_ref(const VectorXd& model, const long double Hl, const long double fl, const long double a1, const long double eta, const long double a3,
...
bool debug_solver_ref(const VectorXd& x, const VectorXd& fl1_all, const VectorXd& fl0_all, const int el, const long double delta0l, 
...
double eta0_fct_ref(const VectorXd& fl0_all){
    VectorXd xfit, rfit;
    //xfit=linspace(0, fl0_all.size()-1, fl0_all.size());
    xfit = Eigen::VectorXd::LinSpaced(fl0_all.size(), 0, fl0_all.size()-1);
    rfit=linfit(xfit, fl0_all); // rfit[0] = Dnu 
...
double eta0_fct_ref(const double Dnu_obs){
...
*/
VectorXd decompose_Alm_fct_ref(const int l, const long double fc_l, const long double eta0, const long double a1, const long double epsilon_nl, const VectorXd& thetas, const std::string filter_type){
...
VectorXd decompose_Alm_fct_GSLgrid_ref(const int l, const long double fc_l, const long double eta0, 
...
VectorXd decompose_CFonly_ref(const int l, const long double fc_l, const long double eta0, const long double a1){
    /*
